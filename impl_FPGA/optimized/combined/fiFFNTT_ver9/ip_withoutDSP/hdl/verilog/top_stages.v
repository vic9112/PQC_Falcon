...
wire   [9:0] grp_PE_fu_86_buf1_address0;
wire    grp_PE_fu_86_buf1_ce0;
reg   [63:0] grp_PE_fu_86_buf1_q0;
wire   [9:0] grp_PE_fu_86_buf1_address1;
wire    grp_PE_fu_86_buf1_ce1;
reg   [63:0] grp_PE_fu_86_buf1_q1;
...
top_stages_stage0_RAM_AUTO_1R1W #(
    .DataWidth( 64 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
stage0_U(
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state21) | (1'b1 == ap_CS_fsm_state17) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state9) | ((mode_read_read_fu_80_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
        grp_PE_fu_86_buf1_q0 = stage1_q0;
    end else if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state2))) begin
        grp_PE_fu_86_buf1_q0 = buf1_q0;
    end else begin
        grp_PE_fu_86_buf1_q0 = 'bx;
    end
end
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) | ((mode_read_read_fu_80_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state2) | ((mode_read_read_fu_80_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state17) | (1'b1 == ap_CS_fsm_state13) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state5) | ((mode_read_read_fu_80_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
        stage0_address0 = grp_PE_fu_86_stage0_address0;
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            ...
            end else if (((mode_read_read_fu_80_p2 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((grp_PE_fu_86_ap_done == 1'b0) & (mode_read_read_fu_80_p2 == 1'd0));
end

assign buf1_d0 = grp_PE_fu_86_stage0_d0;

assign buf1_d1 = grp_PE_fu_86_stage0_d1;

assign grp_PE_fu_86_ap_start = grp_PE_fu_86_ap_start_reg;

assign mode_read_read_fu_80_p2 = mode;

endmodule //top_stages
