...
architecture behave of top_control_s_axi is
    ...
    signal int_mode            : UNSIGNED(15 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MODE_DATA_0 =>
                        rdata_data <= RESIZE(int_mode(15 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MODE_DATA_0) then
                    int_mode(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_mode(15 downto 0));
                end if;
            end if;
        end if;
    end process;
