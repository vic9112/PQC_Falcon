...
reg   [0:0] exitcond6_reg_136;
reg   [63:0] out_buf_i_load_reg_150;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index_cast_fu_105_p1;
wire    ap_block_pp0_stage0_01001;
reg   [9:0] loop_index_fu_50;
wire   [9:0] empty_75_fu_99_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond6_reg_136 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond6_reg_136 == 1'd1))) begin
...
assign empty_75_fu_99_p2 = (ap_sig_allocacmp_loop_index_load + 10'd1);

assign exitcond6_fu_93_p2 = ((ap_sig_allocacmp_loop_index_load == 10'd512) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_WDATA = out_buf_i_load_reg_150;
...
assign out_buf_i_address0 = loop_index_cast_fu_105_p1;
