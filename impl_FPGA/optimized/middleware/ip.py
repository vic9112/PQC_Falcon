...
# Memory allocate
Buffer0_A = allocate(shape=(1024,), dtype=memcell)
Buffer0_B = allocate(shape=(1024,), dtype=memcell)
Buffer1_A = allocate(shape=(1024,), dtype=memcell)
Buffer1_B = allocate(shape=(1024,), dtype=memcell)
