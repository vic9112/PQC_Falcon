...
# 2 "<built-in>" 2
# 1 "../FalconHLS/code_hls/shake.c" 2
# 32 "../FalconHLS/code_hls/shake.c"
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 33 "../FalconHLS/code_hls/shake.c" 2
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 35 "../FalconHLS/code_hls/shake.c" 2
...
process_block(uint64_t *state)
{
 ...
 int round;
     ...
     VITIS_LOOP_104_1: for (round = 0; round < 24; round += 1) {
         ...
         Aso = Eso;
         Asu = Esu;
# 322 "../FalconHLS/code_hls/shake.c"
     }
     ...
     state[23] = Aso;
     state[24] = Asu;
# 775 "../FalconHLS/code_hls/shake.c"
}
