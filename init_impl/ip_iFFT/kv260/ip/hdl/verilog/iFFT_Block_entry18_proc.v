...
module iFFT_Block_entry18_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    logn_c_blk_n;
reg    ap_block_state1;
wire   [63:0] zext_ln1460_fu_48_p1;
wire   [63:0] n_fu_52_p2;
wire   [62:0] hn_fu_58_p4;
wire   [63:0] zext_ln1463_fu_68_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (logn_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_0_preg[31 : 0] <= zext_ln1460_fu_48_p1[31 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        ap_return_2_preg[49] <= 1'b0;
        ap_return_2_preg[50] <= 1'b0;
        ap_return_2_preg[51] <= 1'b0;
        ap_return_2_preg[52] <= 1'b0;
        ap_return_2_preg[53] <= 1'b0;
        ap_return_2_preg[54] <= 1'b0;
        ap_return_2_preg[55] <= 1'b0;
        ap_return_2_preg[56] <= 1'b0;
        ap_return_2_preg[57] <= 1'b0;
        ap_return_2_preg[58] <= 1'b0;
        ap_return_2_preg[59] <= 1'b0;
        ap_return_2_preg[60] <= 1'b0;
        ap_return_2_preg[61] <= 1'b0;
        ap_return_2_preg[62] <= 1'b0;
    end else begin
        if ((~((ap_start == 1'b0) | (logn_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_2_preg[62 : 0] <= zext_ln1463_fu_68_p1[62 : 0];
        end
    end
end
...
assign n_fu_52_p2 = 64'd1 << zext_ln1460_fu_48_p1;

assign zext_ln1460_fu_48_p1 = logn;

assign zext_ln1463_fu_68_p1 = hn_fu_58_p4;

always @ (posedge ap_clk) begin
    ap_return_0_preg[63:32] <= 32'b00000000000000000000000000000000;
    ap_return_2_preg[63] <= 1'b0;
end

endmodule //iFFT_Block_entry18_proc
