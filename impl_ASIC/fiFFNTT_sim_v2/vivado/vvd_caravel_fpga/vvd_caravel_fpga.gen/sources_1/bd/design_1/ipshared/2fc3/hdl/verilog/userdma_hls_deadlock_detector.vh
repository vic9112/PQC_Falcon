...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_72_1_fu_93.inbuf_blk_n) | (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_72_1_fu_93.incount25_blk_n) | (~getinstream_U0.kernel_mode_c_blk_n);
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_25_2_fu_129.inbuf_blk_n) | (~streamtoparallelwithburst_U0.incount25_blk_n) | (~streamtoparallelwithburst_U0.kernel_mode_blk_n);
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~paralleltostreamwithburst_U0.outbuf_blk_n);
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~sendoutstream_U0.outbuf_blk_n);
