set SynModuleInfo {
  ...
  {SRCNAME getinstream_Pipeline_VITIS_LOOP_72_1 MODELNAME getinstream_Pipeline_VITIS_LOOP_72_1 RTLNAME userdma_getinstream_Pipeline_VITIS_LOOP_72_1
    SUBMODULES {
  ...
  {SRCNAME streamtoparallelwithburst_Pipeline_VITIS_LOOP_25_2 MODELNAME streamtoparallelwithburst_Pipeline_VITIS_LOOP_25_2 RTLNAME userdma_streamtoparallelwithburst_Pipeline_VITIS_LOOP_25_2}
  {SRCNAME streamtoparallelwithburst MODELNAME streamtoparallelwithburst RTLNAME userdma_streamtoparallelwithburst}
  {SRCNAME paralleltostreamwithburst_Pipeline_VITIS_LOOP_128_2 MODELNAME paralleltostreamwithburst_Pipeline_VITIS_LOOP_128_2 RTLNAME userdma_paralleltostreamwithburst_Pipeline_VITIS_LOOP_128_2}
  ...
  {SRCNAME sendoutstream MODELNAME sendoutstream RTLNAME userdma_sendoutstream
    SUBMODULES {
      {MODELNAME userdma_flow_control_loop_pipe RTLNAME userdma_flow_control_loop_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME userdma_flow_control_loop_pipe_U}
    }
  }
