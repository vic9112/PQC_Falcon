...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TUSER { O 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TREADY { I 1 bit } outStreamTop_TVALID { O 1 bit } outStreamTop_TLAST { O 1 vector } } \
} "
} else {
...
set InstName userdma_flow_control_loop_pipe_U
set CompName userdma_flow_control_loop_pipe
