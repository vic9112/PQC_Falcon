...
#define XUSERDMA_CONTROL_ADDR_CLR_S2M_STS_DATA 0x60
#define XUSERDMA_CONTROL_BITS_CLR_S2M_STS_DATA 1
#define XUSERDMA_CONTROL_ADDR_CLR_M2S_STS_DATA 0x68
#define XUSERDMA_CONTROL_BITS_CLR_M2S_STS_DATA 1
