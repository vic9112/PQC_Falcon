...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_last_V_reg_107 == 1'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_last_V_reg_107 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
