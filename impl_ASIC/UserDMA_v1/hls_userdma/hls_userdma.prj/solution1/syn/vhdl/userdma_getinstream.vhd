...
port (
    ...
    incount37_din : OUT STD_LOGIC_VECTOR (31 downto 0);
    incount37_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
    incount37_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    incount37_full_n : IN STD_LOGIC;
    incount37_write : OUT STD_LOGIC;
...
attribute shreg_extract : string;
    ...
    signal select_ln69_fu_129_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal select_ln69_reg_162 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_idle : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_ready : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_din : STD_LOGIC_VECTOR (32 downto 0);
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_write : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_write : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inStreamTop_TREADY : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_tmp_last_V_out : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_tmp_last_V_out_ap_vld : STD_LOGIC;
    signal grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_block_state1 : BOOLEAN;
    signal select_ln79_fu_141_p3 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal or_ln66_fu_123_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component userdma_getinstream_Pipeline_VITIS_LOOP_69_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        inStreamTop_TUSER : IN STD_LOGIC_VECTOR (1 downto 0);
        inStreamTop_TLAST : IN STD_LOGIC_VECTOR (0 downto 0);
        select_ln69 : IN STD_LOGIC_VECTOR (11 downto 0);
...
begin
    grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93 : component userdma_getinstream_Pipeline_VITIS_LOOP_69_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start,
        ap_done => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done,
        ap_idle => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_idle,
        ap_ready => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_ready,
        inStreamTop_TVALID => inStreamTop_TVALID_int_regslice,
        inbuf_din => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_din,
        inbuf_num_data_valid => ap_const_lv11_0,
        inbuf_fifo_cap => ap_const_lv11_0,
        inbuf_full_n => inbuf_full_n,
        inbuf_write => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_write,
        incount37_din => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_din,
        incount37_num_data_valid => ap_const_lv3_0,
        incount37_fifo_cap => ap_const_lv3_0,
        incount37_full_n => incount37_full_n,
        incount37_write => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_write,
        inStreamTop_TDATA => inStreamTop_TDATA_int_regslice,
        inStreamTop_TREADY => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inStreamTop_TREADY,
        ...
        select_ln69 => select_ln69_reg_162,
        tmp_last_V_out => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_tmp_last_V_out,
        tmp_last_V_out_ap_vld => grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_tmp_last_V_out_ap_vld);
    ...
    grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_ready = ap_const_logic_1)) then 
                    grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                                        s2m_err_preg(1) <= select_ln79_fu_141_p3(1);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    select_ln69_reg_162(11 downto 10) <= select_ln69_fu_129_p3(11 downto 10);
            end if;
        end if;
    end process;
    select_ln69_reg_162(9 downto 0) <= "0000000000";
    s2m_err_preg(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, kernel_mode_c_full_n, grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done)
    begin
        if ((grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_done = ap_const_logic_0)) then 
    ...
    grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start <= grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_ap_start_reg;
    ...
    inStreamTop_TREADY_int_regslice_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inStreamTop_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            inStreamTop_TREADY_int_regslice <= grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inStreamTop_TREADY;
        else 
    ...
    inbuf_write_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            inbuf_write <= grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_inbuf_write;
        else 
    ...
    incount37_write_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            incount37_write <= grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_incount37_write;
        else 
            incount37_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    or_ln66_fu_123_p2 <= (icmp_ln1065_fu_113_p2 or icmp_ln1065_4_fu_118_p2);

    s2m_err_assign_proc : process(ap_CS_fsm_state4, select_ln79_fu_141_p3, s2m_err_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            s2m_err <= select_ln79_fu_141_p3;
        else 
    ...
    select_ln69_fu_129_p3 <= 
        ap_const_lv12_800 when (or_ln66_fu_123_p2(0) = '1') else 
        ap_const_lv12_400;
    select_ln79_fu_141_p3 <= 
        ap_const_lv2_0 when (grp_getinstream_Pipeline_VITIS_LOOP_69_1_fu_93_tmp_last_V_out(0) = '1') else 
        ap_const_lv2_2;
end behav;
