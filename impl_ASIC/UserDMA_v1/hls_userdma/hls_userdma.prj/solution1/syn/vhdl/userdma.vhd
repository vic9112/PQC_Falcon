...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=5081,HLS_SYN_LUT=9145,HLS_VERSION=2022_1}";
    ...
    signal clr_s2m_sts : STD_LOGIC;
    signal clr_m2s_sts : STD_LOGIC;
    ...
    signal getinstream_U0_incount37_din : STD_LOGIC_VECTOR (31 downto 0);
    signal getinstream_U0_incount37_write : STD_LOGIC;
    signal getinstream_U0_kernel_mode_c_din : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal streamtoparallelwithburst_U0_incount37_read : STD_LOGIC;
    ...
    signal streamtoparallelwithburst_U0_kernel_mode_read : STD_LOGIC;
    ...
    signal paralleltostreamwithburst_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal paralleltostreamwithburst_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal sendoutstream_U0_outStreamTop_TUSER : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal kernel_mode_c_dout : STD_LOGIC_VECTOR (1 downto 0);
    signal kernel_mode_c_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal kernel_mode_c_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component userdma_fifo_w2_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    port (
        ...
        clr_s2m_sts : OUT STD_LOGIC;
        clr_m2s_sts : OUT STD_LOGIC;
...
begin
    ...
    port map (
        ...
        clr_s2m_sts => clr_s2m_sts,
        clr_m2s_sts => clr_m2s_sts,
        ap_start => ap_start,
        interrupt => interrupt,
        ap_ready => ap_ready,
        ap_done => ap_done,
    ...
    port map (
        ...
        incount37_din => getinstream_U0_incount37_din,
        incount37_num_data_valid => incount_num_data_valid,
        incount37_fifo_cap => incount_fifo_cap,
        incount37_full_n => incount_full_n,
        incount37_write => getinstream_U0_incount37_write,
        kernel_mode_c_din => getinstream_U0_kernel_mode_c_din,
        kernel_mode_c_num_data_valid => kernel_mode_c_num_data_valid,
        kernel_mode_c_fifo_cap => kernel_mode_c_fifo_cap,
        kernel_mode_c_full_n => kernel_mode_c_full_n,
        kernel_mode_c_write => getinstream_U0_kernel_mode_c_write);
    ...
    port map (
        ...
        incount37_dout => incount_dout,
        incount37_num_data_valid => incount_num_data_valid,
        incount37_fifo_cap => incount_fifo_cap,
        incount37_empty_n => incount_empty_n,
        incount37_read => streamtoparallelwithburst_U0_incount37_read,
        s2m_buf_sts => streamtoparallelwithburst_U0_s2m_buf_sts,
        s2m_buf_sts_ap_vld => streamtoparallelwithburst_U0_s2m_buf_sts_ap_vld,
        kernel_mode_dout => kernel_mode_c_dout,
        kernel_mode_num_data_valid => kernel_mode_c_num_data_valid,
        kernel_mode_fifo_cap => kernel_mode_c_fifo_cap,
        kernel_mode_empty_n => kernel_mode_c_empty_n,
        kernel_mode_read => streamtoparallelwithburst_U0_kernel_mode_read,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => getinstream_U0_incount37_din,
        if_full_n => incount_full_n,
        if_write => getinstream_U0_incount37_write,
        if_dout => incount_dout,
        if_num_data_valid => incount_num_data_valid,
        if_fifo_cap => incount_fifo_cap,
        if_empty_n => incount_empty_n,
        if_read => streamtoparallelwithburst_U0_incount37_read);

    kernel_mode_c_U : component userdma_fifo_w2_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => getinstream_U0_kernel_mode_c_din,
        if_full_n => kernel_mode_c_full_n,
        if_write => getinstream_U0_kernel_mode_c_write,
        if_dout => kernel_mode_c_dout,
        if_num_data_valid => kernel_mode_c_num_data_valid,
        if_fifo_cap => kernel_mode_c_fifo_cap,
        if_empty_n => kernel_mode_c_empty_n,
        if_read => streamtoparallelwithburst_U0_kernel_mode_read);

    outbuf_U : component userdma_fifo_w33_d1024_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
