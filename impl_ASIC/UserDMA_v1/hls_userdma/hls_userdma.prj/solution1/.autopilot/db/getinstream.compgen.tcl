...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_incount37 \
    op interface \
    ports { incount37_din { O 32 vector } incount37_num_data_valid { I 3 vector } incount37_fifo_cap { I 3 vector } incount37_full_n { I 1 bit } incount37_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_kernel_mode_c \
    op interface \
    ports { kernel_mode_c_din { O 2 vector } kernel_mode_c_num_data_valid { I 2 vector } kernel_mode_c_fifo_cap { I 2 vector } kernel_mode_c_full_n { I 1 bit } kernel_mode_c_write { O 1 bit } } \
} "
}
