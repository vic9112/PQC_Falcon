...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { incount37_dout { I 32 vector } incount37_num_data_valid { I 3 vector } incount37_fifo_cap { I 3 vector } incount37_empty_n { I 1 bit } incount37_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_mode_dout { I 2 vector } kernel_mode_num_data_valid { I 2 vector } kernel_mode_fifo_cap { I 2 vector } kernel_mode_empty_n { I 1 bit } kernel_mode_read { O 1 bit } } \
} "
}
