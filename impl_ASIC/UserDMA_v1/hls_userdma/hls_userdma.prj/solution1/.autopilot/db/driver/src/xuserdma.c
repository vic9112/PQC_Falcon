...
void XUserdma_Set_kernel_mode(XUserdma *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUserdma_WriteReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_KERNEL_MODE_DATA, Data);
}

u32 XUserdma_Get_kernel_mode(XUserdma *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUserdma_ReadReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_KERNEL_MODE_DATA);
    return Data;
}
...
void XUserdma_Set_clr_s2m_sts(XUserdma *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUserdma_WriteReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_CLR_S2M_STS_DATA, Data);
}

u32 XUserdma_Get_clr_s2m_sts(XUserdma *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUserdma_ReadReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_CLR_S2M_STS_DATA);
    return Data;
}

void XUserdma_Set_clr_m2s_sts(XUserdma *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XUserdma_WriteReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_CLR_M2S_STS_DATA, Data);
}

u32 XUserdma_Get_clr_m2s_sts(XUserdma *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XUserdma_ReadReg(InstancePtr->Control_BaseAddress, XUSERDMA_CONTROL_ADDR_CLR_M2S_STS_DATA);
    return Data;
}
