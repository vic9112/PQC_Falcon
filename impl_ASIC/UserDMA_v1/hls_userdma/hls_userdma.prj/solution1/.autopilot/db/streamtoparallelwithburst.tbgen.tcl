...
set C_modelArgList {
	...
	{ incount37 int 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inbuf", "interface" : "fifo", "bitwidth" : 33, "direction" : "READONLY"} , 
 	{ "Name" : "incount37", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ incount37_dout sc_in sc_lv 32 signal 1 } 
	{ incount37_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ incount37_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ incount37_empty_n sc_in sc_logic 1 signal 1 } 
	{ incount37_read sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "incount37_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "incount37", "role": "dout" }} , 
 	...
 	{ "name": "incount37_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "incount37", "role": "empty_n" }} , 
 	{ "name": "incount37_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "incount37", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "inbuf", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_22_2_fu_123", "Port" : "inbuf", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "incount37", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_22_2_fu_123", "Port" : "gmem0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_22_2_fu_123", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_22_2_fu_123.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	incount37 { ap_fifo {  { incount37_dout fifo_port_we 0 32 }  { incount37_num_data_valid fifo_status_num_data_valid 0 3 }  { incount37_fifo_cap fifo_update 0 3 }  { incount37_empty_n fifo_status 0 1 }  { incount37_read fifo_data 1 1 } } }
