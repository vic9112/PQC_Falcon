...
define void @apatb_userdma_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* noalias nonnull dereferenceable(12) %inStreamTop, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* noalias nonnull dereferenceable(12) %outStreamTop, %"struct.ap_uint<2>"* nocapture readonly %kernel_mode, i1* noalias nocapture nonnull %s2m_buf_sts, i1* noalias nocapture nonnull %m2s_buf_sts, %struct.memcell* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %s2mbuf, %struct.memcell* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %m2sbuf, %"struct.ap_uint<2>"* noalias nocapture nonnull %s2m_err, i1 zeroext %clr_s2m_sts, i1 zeroext %clr_m2s_sts) local_unnamed_addr #0 {
entry:
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.32"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.32"(i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i2* %_V_user_V4, i1* %_V_last_V5, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %1)
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.26"(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* nonnull align 512 %0, i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.26"(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i2* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.32"(i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.35"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>.35"(i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"
...
declare void @apatb_userdma_hw(i32*, i4*, i4*, i2*, i1*, i32*, i4*, i4*, i2*, i1*, %"struct.ap_uint<2>"*, i1*, i1*, %struct.memcell*, %struct.memcell*, %"struct.ap_uint<2>"*, i1, i1)
...
define void @userdma_hw_stub_wrapper(i32*, i4*, i4*, i2*, i1*, i32*, i4*, i4*, i2*, i1*, %"struct.ap_uint<2>"*, i1*, i1*, %struct.memcell*, %struct.memcell*, %"struct.ap_uint<2>"*, i1, i1) #6 {
entry:
  %18 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"
  %19 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"
  %20 = bitcast %struct.memcell* %13 to [1024 x %struct.memcell]*
  %21 = bitcast %struct.memcell* %14 to [1024 x %struct.memcell]*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %18, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %19, i32* %5, i4* %6, i4* %7, i2* %8, i1* %9, i1* null, i1* %11, i1* null, i1* %12, [1024 x %struct.memcell]* null, [1024 x %struct.memcell]* %20, [1024 x %struct.memcell]* null, [1024 x %struct.memcell]* %21, %"struct.ap_uint<2>"* null, %"struct.ap_uint<2>"* %15)
  %22 = bitcast [1024 x %struct.memcell]* %20 to %struct.memcell*
  %23 = bitcast [1024 x %struct.memcell]* %21 to %struct.memcell*
  call void @userdma_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %18, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %19, %"struct.ap_uint<2>"* %10, i1* %11, i1* %12, %struct.memcell* %22, %struct.memcell* %23, %"struct.ap_uint<2>"* %15, i1 %16, i1 %17)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %18, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"* %19, i32* %5, i4* %6, i4* %7, i2* %8, i1* %9, i1* null, i1* %11, i1* null, i1* %12, [1024 x %struct.memcell]* null, [1024 x %struct.memcell]* %20, [1024 x %struct.memcell]* null, [1024 x %struct.memcell]* %21, %"struct.ap_uint<2>"* null, %"struct.ap_uint<2>"* %15)
  ret void
}

declare void @userdma_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<32>, 2, 0, 0>, 0>"*, %"struct.ap_uint<2>"*, i1*, i1*, %struct.memcell*, %struct.memcell*, %"struct.ap_uint<2>"*, i1, i1)
