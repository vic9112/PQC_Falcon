...
#define AUTOTB_TVIN_kernel_mode "../tv/cdatafile/c.userdma.autotvin_kernel_mode.dat"
#define AUTOTB_TVOUT_kernel_mode "../tv/cdatafile/c.userdma.autotvout_kernel_mode.dat"
...
#define AUTOTB_TVIN_clr_s2m_sts "../tv/cdatafile/c.userdma.autotvin_clr_s2m_sts.dat"
#define AUTOTB_TVOUT_clr_s2m_sts "../tv/cdatafile/c.userdma.autotvout_clr_s2m_sts.dat"
#define AUTOTB_TVIN_clr_m2s_sts "../tv/cdatafile/c.userdma.autotvin_clr_m2s_sts.dat"
#define AUTOTB_TVOUT_clr_m2s_sts "../tv/cdatafile/c.userdma.autotvout_clr_m2s_sts.dat"
...
#define AUTOTB_TVOUT_PC_kernel_mode "../tv/rtldatafile/rtl.userdma.autotvout_kernel_mode.dat"
...
#define AUTOTB_TVOUT_PC_clr_s2m_sts "../tv/rtldatafile/rtl.userdma.autotvout_clr_s2m_sts.dat"
#define AUTOTB_TVOUT_PC_clr_m2s_sts "../tv/rtldatafile/rtl.userdma.autotvout_clr_m2s_sts.dat"
...
string get_depth_list () {
  ...
  total_list << "{kernel_mode " << kernel_mode_depth << "}\n";
  ...
  total_list << "{clr_s2m_sts " << clr_s2m_sts_depth << "}\n";
  total_list << "{clr_m2s_sts " << clr_m2s_sts_depth << "}\n";
...
void set_string(std::string list, std::string* class_list) {
  ...
  public:
    ...
    int kernel_mode_depth;
    int s2m_buf_sts_depth;
    int m2s_buf_sts_depth;
    int s2mbuf_depth;
    int m2sbuf_depth;
    int s2m_err_depth;
    int clr_s2m_sts_depth;
    int clr_m2s_sts_depth;
    int gmem0_depth;
    int gmem1_depth;
    int trans_num;
  private:
...
tr.send<8>((char*)__xlx_apatb_param_s2mbuf, 1024, 0);
}
#else
try {
static PostCheck<64> pc(AUTOTB_TVOUT_PC_gmem0);
pc.psize = 8;
...
transaction<64> tr(1024);
__xlx_offset_byte_param_s2mbuf = 0*8;
if (__xlx_apatb_param_s2mbuf) {
  tr.import<8>((char*)__xlx_apatb_param_s2mbuf, 1024, 0);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_s2mbuf + i * 8;
...
transaction<64> tr(1024);
__xlx_offset_byte_param_m2sbuf = 0*8;
if (__xlx_apatb_param_m2sbuf) {
  tr.import<8>((char*)__xlx_apatb_param_m2sbuf, 1024, 0);
}
...
if (__xlx_apatb_param_m2sbuf) {
for (size_t i = 0; i < 1024; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_m2sbuf + i * 8;
std::string s = formatData(pos, 64);
...
#endif
// print kernel_mode Transactions
{
aesl_fh.write(AUTOTB_TVIN_kernel_mode, begin_str(AESL_transaction));
{
auto *pos = (unsigned char*)__xlx_apatb_param_kernel_mode;
aesl_fh.write(AUTOTB_TVIN_kernel_mode, formatData(pos, 2));
}
  tcl_file.set_num(1, &tcl_file.kernel_mode_depth);
aesl_fh.write(AUTOTB_TVIN_kernel_mode, end_str());
}
...
// print clr_s2m_sts Transactions
{
aesl_fh.write(AUTOTB_TVIN_clr_s2m_sts, begin_str(AESL_transaction));
{
auto *pos = (unsigned char*)&__xlx_apatb_param_clr_s2m_sts;
aesl_fh.write(AUTOTB_TVIN_clr_s2m_sts, formatData(pos, 1));
}
  tcl_file.set_num(1, &tcl_file.clr_s2m_sts_depth);
aesl_fh.write(AUTOTB_TVIN_clr_s2m_sts, end_str());
}

// print clr_m2s_sts Transactions
{
aesl_fh.write(AUTOTB_TVIN_clr_m2s_sts, begin_str(AESL_transaction));
{
auto *pos = (unsigned char*)&__xlx_apatb_param_clr_m2s_sts;
aesl_fh.write(AUTOTB_TVIN_clr_m2s_sts, formatData(pos, 1));
}
  tcl_file.set_num(1, &tcl_file.clr_m2s_sts_depth);
aesl_fh.write(AUTOTB_TVIN_clr_m2s_sts, end_str());
}

CodeState = CALL_C_DUT;
userdma_hw_stub_wrapper(__xlx_apatb_param_inStreamTop_V_data_V, __xlx_apatb_param_inStreamTop_V_keep_V, __xlx_apatb_param_inStreamTop_V_strb_V, __xlx_apatb_param_inStreamTop_V_user_V, __xlx_apatb_param_inStreamTop_V_last_V, __xlx_apatb_param_outStreamTop_V_data_V, __xlx_apatb_param_outStreamTop_V_keep_V, __xlx_apatb_param_outStreamTop_V_strb_V, __xlx_apatb_param_outStreamTop_V_user_V, __xlx_apatb_param_outStreamTop_V_last_V, __xlx_apatb_param_kernel_mode, __xlx_apatb_param_s2m_buf_sts, __xlx_apatb_param_m2s_buf_sts, __xlx_apatb_param_s2mbuf, __xlx_apatb_param_m2sbuf, __xlx_apatb_param_s2m_err, __xlx_apatb_param_clr_s2m_sts, __xlx_apatb_param_clr_m2s_sts);
