...
`define AESL_DEPTH_kernel_mode 1
...
`define AESL_DEPTH_clr_s2m_sts 1
`define AESL_DEPTH_clr_m2s_sts 1
...
`define AUTOTB_TVIN_kernel_mode_out_wrapc  "../tv/rtldatafile/rtl.userdma.autotvin_kernel_mode.dat"
...
parameter LENGTH_inStreamTop_V_data_V = 2048;
parameter LENGTH_inStreamTop_V_keep_V = 2048;
parameter LENGTH_inStreamTop_V_strb_V = 2048;
parameter LENGTH_inStreamTop_V_user_V = 2048;
parameter LENGTH_inStreamTop_V_last_V = 2048;
parameter LENGTH_outStreamTop_V_data_V = 2049;
parameter LENGTH_outStreamTop_V_keep_V = 2049;
parameter LENGTH_outStreamTop_V_strb_V = 2049;
parameter LENGTH_outStreamTop_V_user_V = 2049;
parameter LENGTH_outStreamTop_V_last_V = 2049;
parameter LENGTH_kernel_mode = 1;
...
parameter LENGTH_clr_s2m_sts = 1;
parameter LENGTH_clr_m2s_sts = 1;
...
reg end_kernel_mode;
reg [31:0] size_kernel_mode;
reg [31:0] size_kernel_mode_backup;
reg end_s2mbuf;
