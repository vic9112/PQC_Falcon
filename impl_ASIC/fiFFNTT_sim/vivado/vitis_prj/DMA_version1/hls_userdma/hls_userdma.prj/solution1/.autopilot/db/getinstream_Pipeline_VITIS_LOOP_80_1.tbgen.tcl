set moduleName getinstream_Pipeline_VITIS_LOOP_80_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {getinstream_Pipeline_VITIS_LOOP_80_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "inStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln80", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln80 sc_in sc_lv 12 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln80", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "select_ln80", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	select_ln80 { ap_none {  { select_ln80 in_data 0 12 } } }
