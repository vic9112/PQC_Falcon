...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { select_ln119 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_din { O 35 vector } outbuf_num_data_valid { I 7 vector } outbuf_fifo_cap { I 7 vector } outbuf_full_n { I 1 bit } outbuf_write { O 1 bit } } \
} "
}
