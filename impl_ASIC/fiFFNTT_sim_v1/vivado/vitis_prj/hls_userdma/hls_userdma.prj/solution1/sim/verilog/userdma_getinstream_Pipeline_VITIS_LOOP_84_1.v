...
module userdma_getinstream_Pipeline_VITIS_LOOP_84_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] select_ln84_cast_fu_103_p1;
reg   [31:0] select_ln84_cast_reg_198;
reg   [0:0] tmp_last_V_reg_203;
wire   [31:0] count_5_fu_140_p2;
reg   [31:0] count_5_reg_208;
wire   [0:0] or_ln100_fu_158_p2;
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (or_ln100_reg_214 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        count_fu_54 <= 32'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln100_reg_214 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        select_ln84_cast_reg_198[11 : 0] <= select_ln84_cast_fu_103_p1[11 : 0];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((or_ln100_reg_214 == 1'd1)) begin
            ap_sig_allocacmp_count_4 = 32'd0;
        end else if ((or_ln100_reg_214 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (or_ln100_reg_214 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln100_reg_214 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((or_ln100_reg_214 == 1'd1) & (incount25_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((inbuf_full_n == 1'b0) | (inStreamTop_TVALID == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((or_ln100_reg_214 == 1'd1) & (incount25_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((inbuf_full_n == 1'b0) | (inStreamTop_TVALID == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((or_ln100_reg_214 == 1'd1) & (incount25_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((inbuf_full_n == 1'b0) | (inStreamTop_TVALID == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((or_ln100_reg_214 == 1'd1) & (incount25_full_n == 1'b0));
end
...
assign icmp_ln100_fu_152_p2 = ((count_5_fu_140_p2 == 32'd32) ? 1'b1 : 1'b0);

assign icmp_ln1073_fu_164_p2 = ((in_len_V_3_fu_146_p2 < select_ln84_cast_reg_198) ? 1'b1 : 1'b0);
...
assign or_ln100_fu_158_p2 = (inStreamTop_TLAST | icmp_ln100_fu_152_p2);

assign select_ln84_cast_fu_103_p1 = select_ln84;

assign tmp_last_V_out = tmp_last_V_reg_203;

always @ (posedge ap_clk) begin
    select_ln84_cast_reg_198[31:12] <= 20'b00000000000000000000;
end

endmodule //userdma_getinstream_Pipeline_VITIS_LOOP_84_1
