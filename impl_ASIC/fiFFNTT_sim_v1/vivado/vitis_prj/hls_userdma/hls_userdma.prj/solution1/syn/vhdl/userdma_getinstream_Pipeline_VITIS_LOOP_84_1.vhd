...
entity userdma_getinstream_Pipeline_VITIS_LOOP_84_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of userdma_getinstream_Pipeline_VITIS_LOOP_84_1 is 
...
attribute shreg_extract : string;
    ...
    signal or_ln100_reg_214 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln84_cast_fu_103_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln84_cast_reg_198 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal or_ln100_fu_158_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln100_reg_214 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
                count_fu_54 <= ap_const_lv32_0;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln100_reg_214 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                or_ln100_reg_214 <= or_ln100_fu_158_p2;
                    select_ln84_cast_reg_198(11 downto 0) <= select_ln84_cast_fu_103_p1(11 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    select_ln84_cast_reg_198(31 downto 12) <= "00000000000000000000";
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, inStreamTop_TVALID, inbuf_full_n, incount25_full_n, or_ln100_reg_214)
    begin
                ap_block_pp0_stage0_01001 <= (((or_ln100_reg_214 = ap_const_lv1_1) and (incount25_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((inbuf_full_n = ap_const_logic_0) or (inStreamTop_TVALID = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, inStreamTop_TVALID, inbuf_full_n, incount25_full_n, or_ln100_reg_214)
    begin
                ap_block_pp0_stage0_11001 <= (((or_ln100_reg_214 = ap_const_lv1_1) and (incount25_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((inbuf_full_n = ap_const_logic_0) or (inStreamTop_TVALID = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, inStreamTop_TVALID, inbuf_full_n, incount25_full_n, or_ln100_reg_214)
    begin
                ap_block_pp0_stage0_subdone <= (((or_ln100_reg_214 = ap_const_lv1_1) and (incount25_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((inbuf_full_n = ap_const_logic_0) or (inStreamTop_TVALID = ap_const_logic_0))));
    end process;
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(incount25_full_n, or_ln100_reg_214)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((or_ln100_reg_214 = ap_const_lv1_1) and (incount25_full_n = ap_const_logic_0));
    end process;
    ...
    ap_sig_allocacmp_count_4_assign_proc : process(ap_enable_reg_pp0_iter2, or_ln100_reg_214, ap_block_pp0_stage0, count_5_reg_208, count_fu_54)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then
            if ((or_ln100_reg_214 = ap_const_lv1_1)) then 
                ap_sig_allocacmp_count_4 <= ap_const_lv32_0;
            elsif ((or_ln100_reg_214 = ap_const_lv1_0)) then 
    ...
    icmp_ln100_fu_152_p2 <= "1" when (count_5_fu_140_p2 = ap_const_lv32_20) else "0";
    icmp_ln1073_fu_164_p2 <= "1" when (unsigned(in_len_V_3_fu_146_p2) < unsigned(select_ln84_cast_reg_198)) else "0";
    ...
    incount25_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, incount25_full_n, or_ln100_reg_214, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (or_ln100_reg_214 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    incount25_write_assign_proc : process(ap_enable_reg_pp0_iter2, or_ln100_reg_214, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln100_reg_214 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    or_ln100_fu_158_p2 <= (inStreamTop_TLAST or icmp_ln100_fu_152_p2);
    select_ln84_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln84),32));
