        ...
        begin
            ...
            case (index1)
                ...
                1 : begin
                    case(index2)
                    2: begin
                        if (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_72_1_fu_93.inbuf_blk_n) begin
                        ...
                        if (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_72_1_fu_93.incount25_blk_n) begin
                        ...
                        if (~getinstream_U0.kernel_mode_c_blk_n) begin
                            if (~kernel_mode_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'userdma_userdma.kernel_mode_c_U' written by process 'userdma_userdma.streamtoparallelwithburst_U0'");
                                $fdisplay(fp, "Dependence_Channel_path userdma_userdma.kernel_mode_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~kernel_mode_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'userdma_userdma.kernel_mode_c_U' read by process 'userdma_userdma.streamtoparallelwithburst_U0'");
                                $fdisplay(fp, "Dependence_Channel_path userdma_userdma.kernel_mode_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                2 : begin
                    case(index2)
                    1: begin
                        if (~streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_25_2_fu_129.inbuf_blk_n) begin
                            if (~inbuf_U.if_empty_n) begin
                        ...
                        if (~streamtoparallelwithburst_U0.incount25_blk_n) begin
                            if (~incount_U.if_empty_n) begin
                        ...
                        if (~streamtoparallelwithburst_U0.kernel_mode_blk_n) begin
                            if (~kernel_mode_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'userdma_userdma.kernel_mode_c_U' written by process 'userdma_userdma.getinstream_U0'");
                                $fdisplay(fp, "Dependence_Channel_path userdma_userdma.kernel_mode_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~kernel_mode_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'userdma_userdma.kernel_mode_c_U' read by process 'userdma_userdma.getinstream_U0'");
                                $fdisplay(fp, "Dependence_Channel_path userdma_userdma.kernel_mode_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                3 : begin
                    case(index2)
                    4: begin
                        if (~paralleltostreamwithburst_U0.outbuf_blk_n) begin
                ...
                4 : begin
                    case(index2)
                    3: begin
                        if (~sendoutstream_U0.outbuf_blk_n) begin
                            if (~outbuf_U.if_empty_n) begin
