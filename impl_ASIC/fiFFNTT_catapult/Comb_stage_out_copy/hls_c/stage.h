...
public:
    ...
    void CCS_BLOCK(run) (ac_channel<bool> &ap_start,ac_channel<bool> &ap_done,u16 &mode1,Stream1 in[1024],Stream1 out[1024],ac_channel<Stream1> &out1) {
        bool start;  
        start=ap_start.read();
        bool mode;
	    bool inverse;
    ...
    void PE(unsigned short int &t_in, unsigned short int &m_in, bool &mode,bool &inverse,Stream1 in[1024],Stream1 out[1024]){
