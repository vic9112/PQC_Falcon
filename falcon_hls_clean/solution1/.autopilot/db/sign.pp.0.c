...
# 2 "<built-in>" 2
# 1 "hls_source/sign.c" 2
# 32 "hls_source/sign.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "hls_source/sign.c" 2
# 52 "hls_source/sign.c"
unsigned ffLDL_treesize(unsigned logn)
{
# 63 "hls_source/sign.c"
 return (logn + 1) << logn;
}
...
# 1428 "hls_source/sign.c"
 sw = (uint32_t)s;
 sw ^= (sw ^ 63) & -((63 - sw) >> 31);
 s = (int)sw;
# 1443 "hls_source/sign.c"
