...
#pragma HLS DATAFLOW
# 938 "hls_source/fft.c"
 unsigned u;
 size_t t, n, hn, m;
# 952 "hls_source/fft.c"
 n = (size_t) 1 << logn;
 hn = n >> 1;
 t = hn;

 VITIS_LOOP_956_1: for (u = 1, m = 2; u < logn; u++, m <<= 1) {
#pragma HLS LOOP_TRIPCOUNT max=9
 size_t ht, hm, i1, j1;

  ht = t >> 1;
  hm = m >> 1;
  VITIS_LOOP_962_2: for (i1 = 0, j1 = 0; i1 < hm; i1++, j1 += t) {
#pragma HLS LOOP_TRIPCOUNT max=56
 size_t j, j2;
   j2 = j1 + ht;
   fpr s_re, s_im;
   ...
   VITIS_LOOP_971_3: for (j = j1; j < j2; j++) {
#pragma HLS LOOP_TRIPCOUNT max=56
...
# 997 "hls_source/fft.c"
void iFFT_top(fpr f[1024]) {
# 1012 "hls_source/fft.c"
 iFFT(f, 10);
 iFFT(f, 9);
 iFFT(f, 8);
 iFFT(f, 7);
...
#pragma HLS array_partition variable=Stage_I dim=1 complete
 ...
 case 10:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1046_1: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1064_2: for (u = 0; u < n / 2; u++) {
 ...
 case 9:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1080_3: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1098_4: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 8:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1114_5: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1132_6: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 7:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1148_7: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1166_8: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 6:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1182_9: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1200_10: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 5:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1216_11: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1234_12: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 4:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1250_13: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1268_14: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 3:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1284_15: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1302_16: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 2:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1318_17: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1336_18: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
 ...
 case 1:
  ...
  memcpy(Stage_R[0], f, hn * 8);
  memcpy(Stage_I[0], f + hn, hn * 8);
  VITIS_LOOP_1352_19: for (u, i = 1; u > 1; u--, ++i) {
#pragma HLS unroll
 ...
 size_t hm, dt;
  ...
  if (logn > 0) {
   ...
   ni = fpr_p2_tab[logn];
   VITIS_LOOP_1370_20: for (u = 0; u < n / 2; u++) {
    f[u] = fpr_mul(Stage_R[(i - 1) % 2][u], ni);
    f[u + hn] = fpr_mul(Stage_I[(i - 1) % 2][u], ni);
   }
  }
...
# 1457 "hls_source/fft.c"
 ...
 m = n;
 hn = n >> 1;
 VITIS_LOOP_1463_1: for (u = logn; u > 1; u--) {
#pragma HLS LOOP_TRIPCOUNT min=0 max=1
 size_t hm, dt, i1, j1;

  hm = m >> 1;
  dt = t << 1;
  VITIS_LOOP_1469_2: for (i1 = 0, j1 = 0; j1 < hn; i1++, j1 += dt) {
#pragma HLS LOOP_TRIPCOUNT min=0 max=1
 size_t j, j2;
   ...
   s_re = fpr_gm_tab[((hm + i1) << 1) + 0];
   s_im = fpr_neg(fpr_gm_tab[((hm + i1) << 1) + 1]);
   VITIS_LOOP_1478_3: for (j = j1; j < j2; j++) {
...
#pragma HLS PIPELINE II=28
 ...
 fpr ni;
 ni = fpr_p2_tab[logn];
 VITIS_LOOP_1503_4: for (u = 0; u < n; u++) {
