...
# 2 "<built-in>" 2
# 1 "hls_source/rng.c" 2
# 33 "hls_source/rng.c"
# 1 "hls_source/header.h" 1
...
void prng_init(prng *p, inner_shake256_context *src)
{
 ...
 VITIS_LOOP_49_1: for (i = 0; i < 14; i ++) {
  uint32_t w;
...
#pragma HLS LOOP_TRIPCOUNT max=8
 uint32_t state[16];
  ...
  VITIS_LOOP_105_2: for (i = 0; i < 10; i ++) {
# 122 "hls_source/rng.c"
   VITIS_LOOP_122_3: do { state[0] += state[4]; state[12] ^= state[0]; state[12] = (state[12] << 16) | (state[12] >> 16); state[8] += state[12]; state[4] ^= state[8]; state[4] = (state[4] << 12) | (state[4] >> 20); state[0] += state[4]; state[12] ^= state[0]; state[12] = (state[12] << 8) | (state[12] >> 24); state[8] += state[12]; state[4] ^= state[8]; state[4] = (state[4] << 7) | (state[4] >> 25); } while (0);
   VITIS_LOOP_123_4: do { state[1] += state[5]; state[13] ^= state[1]; state[13] = (state[13] << 16) | (state[13] >> 16); state[9] += state[13]; state[5] ^= state[9]; state[5] = (state[5] << 12) | (state[5] >> 20); state[1] += state[5]; state[13] ^= state[1]; state[13] = (state[13] << 8) | (state[13] >> 24); state[9] += state[13]; state[5] ^= state[9]; state[5] = (state[5] << 7) | (state[5] >> 25); } while (0);
   VITIS_LOOP_124_5: do { state[2] += state[6]; state[14] ^= state[2]; state[14] = (state[14] << 16) | (state[14] >> 16); state[10] += state[14]; state[6] ^= state[10]; state[6] = (state[6] << 12) | (state[6] >> 20); state[2] += state[6]; state[14] ^= state[2]; state[14] = (state[14] << 8) | (state[14] >> 24); state[10] += state[14]; state[6] ^= state[10]; state[6] = (state[6] << 7) | (state[6] >> 25); } while (0);
   VITIS_LOOP_125_6: do { state[3] += state[7]; state[15] ^= state[3]; state[15] = (state[15] << 16) | (state[15] >> 16); state[11] += state[15]; state[7] ^= state[11]; state[7] = (state[7] << 12) | (state[7] >> 20); state[3] += state[7]; state[15] ^= state[3]; state[15] = (state[15] << 8) | (state[15] >> 24); state[11] += state[15]; state[7] ^= state[11]; state[7] = (state[7] << 7) | (state[7] >> 25); } while (0);
   VITIS_LOOP_126_7: do { state[0] += state[5]; state[15] ^= state[0]; state[15] = (state[15] << 16) | (state[15] >> 16); state[10] += state[15]; state[5] ^= state[10]; state[5] = (state[5] << 12) | (state[5] >> 20); state[0] += state[5]; state[15] ^= state[0]; state[15] = (state[15] << 8) | (state[15] >> 24); state[10] += state[15]; state[5] ^= state[10]; state[5] = (state[5] << 7) | (state[5] >> 25); } while (0);
   VITIS_LOOP_127_8: do { state[1] += state[6]; state[12] ^= state[1]; state[12] = (state[12] << 16) | (state[12] >> 16); state[11] += state[12]; state[6] ^= state[11]; state[6] = (state[6] << 12) | (state[6] >> 20); state[1] += state[6]; state[12] ^= state[1]; state[12] = (state[12] << 8) | (state[12] >> 24); state[11] += state[12]; state[6] ^= state[11]; state[6] = (state[6] << 7) | (state[6] >> 25); } while (0);
   VITIS_LOOP_128_9: do { state[2] += state[7]; state[13] ^= state[2]; state[13] = (state[13] << 16) | (state[13] >> 16); state[8] += state[13]; state[7] ^= state[8]; state[7] = (state[7] << 12) | (state[7] >> 20); state[2] += state[7]; state[13] ^= state[2]; state[13] = (state[13] << 8) | (state[13] >> 24); state[8] += state[13]; state[7] ^= state[8]; state[7] = (state[7] << 7) | (state[7] >> 25); } while (0);
   VITIS_LOOP_129_10: do { state[3] += state[4]; state[14] ^= state[3]; state[14] = (state[14] << 16) | (state[14] >> 16); state[9] += state[14]; state[4] ^= state[9]; state[4] = (state[4] << 12) | (state[4] >> 20); state[3] += state[4]; state[14] ^= state[3]; state[14] = (state[14] << 8) | (state[14] >> 24); state[9] += state[14]; state[4] ^= state[9]; state[4] = (state[4] << 7) | (state[4] >> 25); } while (0);



  }

  VITIS_LOOP_135_11: for (v = 0; v < 4; v ++) {
   state[v] += CW[v];
  }
  VITIS_LOOP_138_12: for (v = 4; v < 14; v ++) {
  ...
  VITIS_LOOP_151_13: for (v = 0; v < 16; v ++) {
