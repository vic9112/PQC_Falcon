...
# 2 "<built-in>" 2
# 1 "hls_source/common.c" 2
# 32 "hls_source/common.c"
...
{
# 50 "hls_source/common.c"
 size_t n;

 n = (size_t)1 << logn;
 VITIS_LOOP_53_1: while (n > 0) {
  uint8_t buf[2];
  uint32_t w;
...
# 103 "hls_source/common.c"
 ...
 m = n + over;
 tt1 = (uint16_t *)tmp;
 VITIS_LOOP_131_1: for (u = 0; u < m; u ++) {
  uint8_t buf[2];
  uint32_t w, wr;
...
# 159 "hls_source/common.c"
 VITIS_LOOP_159_2: for (p = 1; p <= over; p <<= 1) {
  unsigned v;
# 175 "hls_source/common.c"
  v = 0;
  VITIS_LOOP_176_3: for (u = 0; u < m; u ++) {
   uint16_t *s, *d;
   unsigned j, sv, dv, mk;
 ...
 const int16_t *s1, const int16_t *s2, unsigned logn)
{
 ...
 s = 0;
 ng = 0;
 VITIS_LOOP_271_1: for (u = 0; u < n; u ++) {
  int32_t z;
 ...
 uint32_t sqn, const int16_t *s2, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 ng = -(sqn >> 31);
 VITIS_LOOP_296_1: for (u = 0; u < n; u ++) {
