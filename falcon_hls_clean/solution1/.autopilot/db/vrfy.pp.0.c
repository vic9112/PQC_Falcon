...
# 2 "<built-in>" 2
# 1 "hls_source/vrfy.c" 2
# 32 "hls_source/vrfy.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "hls_source/vrfy.c" 2
# 58 "hls_source/vrfy.c"
...
mq_poly_tomonty(uint16_t *f, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_606_1: for (u = 0; u < n; u ++) {
...
mq_poly_montymul_ntt(uint16_t *f, const uint16_t *g, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_621_1: for (u = 0; u < n; u ++) {
...
mq_poly_sub(uint16_t *f, const uint16_t *g, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_635_1: for (u = 0; u < n; u ++) {
 ...
 const uint16_t *h, unsigned logn, uint8_t *tmp)
{
 ...
 VITIS_LOOP_786_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 VITIS_LOOP_805_2: for (u = 0; u < n; u ++) {
  int32_t w;
...
int
compute_public(uint16_t h[1024],
 const int8_t f[1024], const int8_t g[1024], unsigned logn, uint8_t tmp[4096])
{
#pragma HLS INTERFACE mode=m_axi depth=1024 port=h
#pragma HLS INTERFACE mode=m_axi depth=1024 port=f
#pragma HLS INTERFACE mode=m_axi depth=1024 port=g
#pragma HLS INTERFACE mode=m_axi depth=4096 port=tmp
#pragma HLS INTERFACE mode=s_axilite port=return
#pragma HLS INTERFACE mode=s_axilite port=logn
 size_t u, n;
 uint16_t *tt;

 n = (size_t)1 << logn;
 tt = (uint16_t *)tmp;
 VITIS_LOOP_836_1: for (u = 0; u < n; u ++) {
  tt[u] = (uint16_t)mq_conv_small(f[u]);
  h[u] = (uint16_t)mq_conv_small(g[u]);
 }
 mq_NTT(h, logn);
 mq_NTT(tt, logn);
 VITIS_LOOP_842_2: for (u = 0; u < n; u ++) {
  if (tt[u] == 0) {
   return 0;
  }
 ...
 unsigned logn, uint8_t *tmp)
{
 ...
 t1 = (uint16_t *)tmp;
 t2 = t1 + n;
 VITIS_LOOP_864_1: for (u = 0; u < n; u ++) {
 ...
 VITIS_LOOP_872_2: for (u = 0; u < n; u ++) {
  t2[u] = (uint16_t)mq_conv_small(f[u]);
 }
 mq_NTT(t2, logn);
 VITIS_LOOP_876_3: for (u = 0; u < n; u ++) {
  if (t2[u] == 0) {
   return 0;
  }
 ...
 mq_iNTT(t1, logn);
 VITIS_LOOP_883_4: for (u = 0; u < n; u ++) {
  uint32_t w;
  int32_t gi;
 ...
 const int16_t *s2, unsigned logn, uint8_t *tmp)
{
 ...
 n = (size_t)1 << logn;
 tt = (uint16_t *)tmp;
 VITIS_LOOP_909_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 mq_NTT(tt, logn);
 r = 0;
 VITIS_LOOP_918_2: for (u = 0; u < n; u ++) {
  r |= (uint32_t)(tt[u] - 1);
 }
 return (int)(1u - (r >> 31));
}
 ...
 unsigned logn, uint8_t *tmp)
{
 ...
 tt = (uint16_t *)tmp;
 VITIS_LOOP_941_1: for (u = 0; u < n; u ++) {
  uint32_t w;
...
# 961 "hls_source/vrfy.c"
 mq_NTT(tt, logn);
 mq_NTT(h, logn);
 r = 0;
 VITIS_LOOP_964_2: for (u = 0; u < n; u ++) {
  r |= (uint32_t)(tt[u] - 1);
  h[u] = (uint16_t)mq_div_12289(h[u], tt[u]);
 }
 mq_iNTT(h, logn);
...
count_nttzero(const int16_t *sig, unsigned logn, uint8_t *tmp)
{
 ...
 n = (size_t)1 << logn;
 s2 = (uint16_t *)tmp;
 VITIS_LOOP_990_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 mq_NTT(s2, logn);
 r = 0;
 VITIS_LOOP_999_2: for (u = 0; u < n; u ++) {
  uint32_t w;
