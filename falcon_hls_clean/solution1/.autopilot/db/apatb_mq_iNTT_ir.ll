; ModuleID = '/home/ubuntu/Desktop/Vic_PQC_Falcon/falcon_hls_clean/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_mq_iNTT_ir(i16* noalias nocapture nonnull %a, i32 %logn) local_unnamed_addr #0 {
entry:
  %a_copy = alloca [1024 x i16], align 512
  %0 = bitcast i16* %a to [1024 x i16]*
  call fastcc void @copy_in([1024 x i16]* nonnull %0, [1024 x i16]* nonnull align 512 %a_copy)
  %1 = getelementptr inbounds [1024 x i16], [1024 x i16]* %a_copy, i32 0, i32 0
  call void @apatb_mq_iNTT_hw(i16* %1, i32 %logn)
  call void @copy_back([1024 x i16]* %0, [1024 x i16]* %a_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_in([1024 x i16]* noalias readonly, [1024 x i16]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([1024 x i16]* noalias, [1024 x i16]* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1024i16([1024 x i16]* %0, [1024 x i16]* align 512 %1)
  ret void
}

declare void @apatb_mq_iNTT_hw(i16*, i32)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([1024 x i16]* noalias, [1024 x i16]* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1024i16([1024 x i16]* %0, [1024 x i16]* align 512 %1)
  ret void
}

define void @mq_iNTT_hw_stub_wrapper(i16*, i32) #4 {
entry:
  %2 = bitcast i16* %0 to [1024 x i16]*
  call void @copy_out([1024 x i16]* null, [1024 x i16]* %2)
  %3 = bitcast [1024 x i16]* %2 to i16*
  call void @mq_iNTT_hw_stub(i16* %3, i32 %1)
  call void @copy_in([1024 x i16]* null, [1024 x i16]* %2)
  ret void
}

declare void @mq_iNTT_hw_stub(i16*, i32)
