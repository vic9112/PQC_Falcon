...
# 2 "<built-in>" 2
# 1 "hls_source/shake.c" 2
# 32 "hls_source/shake.c"
...
process_block(uint64_t *state)
{
 ...
 int round;
     ...
     VITIS_LOOP_104_1: for (round = 0; round < 24; round += 1) {
...
i_shake256_inject(inner_shake256_context *sc, const uint8_t *in, size_t len)
{
 ...
 VITIS_LOOP_798_1: while (len > 0) {
  ...
  VITIS_LOOP_805_2: for (u = 0; u < clen; u ++) {
   size_t v;
