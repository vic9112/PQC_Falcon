...
set id 4
set name mq_iNTT_am_addmul_15s_17s_14ns_32_4_1
...
set id 5
set name mq_iNTT_mul_mul_16s_14ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {16 1 +} i1 {14 0 +} p {16 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 6
set name mq_iNTT_mac_muladd_16ns_14ns_32s_32_4_1
...
set ce_signed 0
set out_width 32
set arg_lists {i0 {16 0 +} i1 {14 0 +} m {30 0 +} i2 {32 1 +} p {32 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_indvars_iv_i \
    op interface \
    ports { indvars_iv_i { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln164_1 { I 14 vector } } \
} "
}
