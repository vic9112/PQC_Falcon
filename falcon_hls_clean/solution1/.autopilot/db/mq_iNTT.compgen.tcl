...
# FIFO definition: 
set ID 31
set FifoName mq_iNTT_fifo_w64_d3_S
set InstName a_c_U
...
# FIFO definition: 
set ID 32
set FifoName mq_iNTT_fifo_w64_d2_S
set InstName m_6_loc_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 33 \
			corename mq_iNTT_control_axilite \
			name mq_iNTT_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mq_iNTT_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
