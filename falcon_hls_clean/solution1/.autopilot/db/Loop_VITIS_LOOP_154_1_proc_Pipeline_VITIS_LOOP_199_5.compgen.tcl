...
set name mq_iNTT_mul_31ns_16ns_32_1_1
...
set id 20
set name mq_iNTT_mac_muladd_16ns_14ns_32ns_32_4_1
...
set ce_signed 0
set out_width 32
set arg_lists {i0 {16 0 +} i1 {14 0 +} m {30 0 +} i2 {32 0 +} p {32 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    id 26 \
    name ni_cast12_i_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_ni_cast12_i_reload \
    op interface \
    ports { ni_cast12_i_reload { I 31 vector } } \
} "
}
