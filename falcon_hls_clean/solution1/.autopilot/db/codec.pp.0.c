...
# 2 "<built-in>" 2
# 1 "hls_source/codec.c" 2
# 32 "hls_source/codec.c"
 ...
 const uint16_t *x, unsigned logn)
{
 ...
 acc = 0;
 acc_len = 0;
 VITIS_LOOP_61_2: for (u = 0; u < n; u ++) {
  acc = (acc << 14) | x[u];
  acc_len += 14;
  VITIS_LOOP_64_3: while (acc_len >= 8) {
   acc_len -= 8;
 ...
 const int16_t *x, unsigned logn, unsigned bits)
{
 ...
 maxv = (1 << (bits - 1)) - 1;
 minv = -maxv;
 VITIS_LOOP_130_1: for (u = 0; u < n; u ++) {
 ...
 VITIS_LOOP_146_2: for (u = 0; u < n; u ++) {
  acc = (acc << bits) | ((uint16_t)x[u] & mask);
  acc_len += bits;
  VITIS_LOOP_149_3: while (acc_len >= 8) {
   acc_len -= 8;
   *buf ++ = (uint8_t)(acc >> acc_len);
  }
 }
 ...
 const void *in, size_t max_in_len)
{
 ...
 VITIS_LOOP_183_1: while (u < n) {
  acc = (acc << 8) | *buf ++;
  acc_len += 8;
  VITIS_LOOP_186_2: while (acc_len >= bits && u < n) {
   uint32_t w;
 ...
 const int8_t *x, unsigned logn, unsigned bits)
{
 ...
 maxv = (1 << (bits - 1)) - 1;
 minv = -maxv;
 VITIS_LOOP_226_1: for (u = 0; u < n; u ++) {
  if (x[u] < minv || x[u] > maxv) {
   return 0;
  }
 }
 ...
 acc_len = 0;
 mask = ((uint32_t)1 << bits) - 1;
 VITIS_LOOP_242_2: for (u = 0; u < n; u ++) {
  acc = (acc << bits) | ((uint8_t)x[u] & mask);
  acc_len += bits;
  VITIS_LOOP_245_3: while (acc_len >= 8) {
   acc_len -= 8;
   *buf ++ = (uint8_t)(acc >> acc_len);
  }
 }
 ...
 const void *in, size_t max_in_len)
{
 ...
 mask1 = ((uint32_t)1 << bits) - 1;
 mask2 = (uint32_t)1 << (bits - 1);
 VITIS_LOOP_279_1: while (u < n) {
  acc = (acc << 8) | *buf ++;
  acc_len += 8;
  VITIS_LOOP_282_2: while (acc_len >= bits && u < n) {
   uint32_t w;
 ...
 const int16_t *x, unsigned logn)
{
 ...
 VITIS_LOOP_323_1: for (u = 0; u < n; u ++) {
 ...
 acc_len = 0;
 v = 0;
 VITIS_LOOP_332_2: for (u = 0; u < n; u ++) {
  int t;
  unsigned w;
...
# 368 "hls_source/codec.c"
  ...
  VITIS_LOOP_375_3: while (acc_len >= 8) {
   acc_len -= 8;
   if (buf != ((void*)0)) {
    if (v >= max_out_len) {
     return 0;
 ...
 const void *in, size_t max_in_len)
{
 ...
 acc_len = 0;
 v = 0;
 VITIS_LOOP_419_1: for (u = 0; u < n; u ++) {
  unsigned b, s, m;
