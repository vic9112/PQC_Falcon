...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=5321,HLS_SYN_LUT=6068,HLS_VERSION=2022_1}";
    ...
    signal getinstream_U0_incount25_write : STD_LOGIC;
    ...
    signal inbuf_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal inbuf_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    signal inbuf_empty_n : STD_LOGIC;
    signal incount_full_n : STD_LOGIC;
    signal incount_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal incount_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal incount_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal outbuf_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal outbuf_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component userdma_fifo_w33_d32_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component userdma_fifo_w35_d32_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        incount25_din => getinstream_U0_incount25_din,
        incount25_num_data_valid => incount_num_data_valid,
        incount25_fifo_cap => incount_fifo_cap,
        incount25_full_n => incount_full_n,
        incount25_write => getinstream_U0_incount25_write,
    ...
    port map (
        ...
        incount25_dout => incount_dout,
        incount25_num_data_valid => incount_num_data_valid,
        incount25_fifo_cap => incount_fifo_cap,
        incount25_empty_n => incount_empty_n,
        incount25_read => streamtoparallelwithburst_U0_incount25_read,
    ...
    inbuf_U : component userdma_fifo_w33_d32_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    incount_U : component userdma_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => getinstream_U0_incount25_din,
        if_full_n => incount_full_n,
        if_write => getinstream_U0_incount25_write,
        if_dout => incount_dout,
        if_num_data_valid => incount_num_data_valid,
        if_fifo_cap => incount_fifo_cap,
        if_empty_n => incount_empty_n,
        if_read => streamtoparallelwithburst_U0_incount25_read);
    ...
    outbuf_U : component userdma_fifo_w35_d32_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
