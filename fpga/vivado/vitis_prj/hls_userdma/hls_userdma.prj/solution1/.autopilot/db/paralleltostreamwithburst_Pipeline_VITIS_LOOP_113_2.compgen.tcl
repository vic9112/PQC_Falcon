...
eval "cg_default_interface_gen_dc { \
    id 44 \
    name select_ln95_cast_cast \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln95_cast_cast \
    op interface \
    ports { select_ln95_cast_cast { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_din { O 35 vector } outbuf_num_data_valid { I 6 vector } outbuf_fifo_cap { I 6 vector } outbuf_full_n { I 1 bit } outbuf_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_shl_ln117_cast \
    op interface \
    ports { shl_ln117_cast { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln95 \
    op interface \
    ports { icmp_ln95 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 49 \
    name in_memory_assign \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_in_memory_assign \
    op interface \
    ports { in_memory_assign { I 64 vector } } \
} "
}
