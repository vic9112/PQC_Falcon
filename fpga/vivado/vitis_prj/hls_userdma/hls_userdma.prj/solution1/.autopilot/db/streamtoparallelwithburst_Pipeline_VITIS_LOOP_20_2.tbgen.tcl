set moduleName streamtoparallelwithburst_Pipeline_VITIS_LOOP_20_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {streamtoparallelwithburst_Pipeline_VITIS_LOOP_20_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ tmp int 32 regular  }
	{ zext_ln20 int 6 regular  }
	{ gmem0 int 64 regular {axi_master 1}  }
	{ shl_ln25 int 8 regular  }
	{ inbuf int 33 regular {fifo 0 volatile }  }
	{ icmp_ln14 int 1 regular  }
	{ out_memory_assign int 64 regular  }
	{ final_s2m_len int 32 regular {pointer 0} {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tmp", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln20", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "shl_ln25", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "inbuf", "interface" : "fifo", "bitwidth" : 33, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln14", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "out_memory_assign", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "final_s2m_len", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ inbuf_dout sc_in sc_lv 33 signal 4 } 
	{ inbuf_num_data_valid sc_in sc_lv 6 signal 4 } 
	{ inbuf_fifo_cap sc_in sc_lv 6 signal 4 } 
	{ inbuf_empty_n sc_in sc_logic 1 signal 4 } 
	{ inbuf_read sc_out sc_logic 1 signal 4 } 
	...
	{ m_axi_gmem0_WDATA sc_out sc_lv 64 signal 2 } 
	{ m_axi_gmem0_WSTRB sc_out sc_lv 8 signal 2 } 
	...
	{ m_axi_gmem0_RDATA sc_in sc_lv 64 signal 2 } 
	...
	{ zext_ln20 sc_in sc_lv 6 signal 1 } 
	{ shl_ln25 sc_in sc_lv 8 signal 3 } 
	{ icmp_ln14 sc_in sc_lv 1 signal 5 } 
	{ out_memory_assign sc_in sc_lv 64 signal 6 } 
	{ final_s2m_len sc_in sc_lv 32 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln20", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln20", "role": "default" }} , 
 	{ "name": "shl_ln25", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "shl_ln25", "role": "default" }} , 
 	{ "name": "icmp_ln14", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln14", "role": "default" }} , 
 	{ "name": "out_memory_assign", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "out_memory_assign", "role": "default" }} , 
 	{ "name": "final_s2m_len", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "final_s2m_len", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	zext_ln20 { ap_none {  { zext_ln20 in_data 0 6 } } }
	...
	shl_ln25 { ap_none {  { shl_ln25 in_data 0 8 } } }
	inbuf { ap_fifo {  { inbuf_dout fifo_port_we 0 33 }  { inbuf_num_data_valid fifo_status_num_data_valid 0 6 }  { inbuf_fifo_cap fifo_update 0 6 }  { inbuf_empty_n fifo_status 0 1 }  { inbuf_read fifo_data 1 1 } } }
	icmp_ln14 { ap_none {  { icmp_ln14 in_data 0 1 } } }
	out_memory_assign { ap_none {  { out_memory_assign in_data 0 64 } } }
	final_s2m_len { ap_none {  { final_s2m_len in_data 0 32 } } }
}
