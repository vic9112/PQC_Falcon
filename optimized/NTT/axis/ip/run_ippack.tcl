...
set hdl_module_list {NTT_regslice_both
NTT_flow_control_loop_pipe
...
NTT_regslice_both
NTT_flow_control_loop_pipe
NTT_in_buf_RAM_AUTO_1R1W_memcore
NTT_in_buf_RAM_AUTO_1R1W
NTT_out_buf_RAM_AUTO_1R1W_memcore
NTT_out_buf_RAM_AUTO_1R1W
NTT_control_s_axi
Loop_1_proc4
ntt_stage
ntt_stage_clone
ntt_stage_clone_clone
ntt_10_stages
Loop_2_proc5
NTT
}
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control a_in a_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 7471 II x}
