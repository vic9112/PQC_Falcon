...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name fiFFNTT_dsub_64ns_64ns_64_5_full_dsp_0_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name fiFFNTT_dsub_64ns_64ns_64_5_full_dsp_0_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips fiFFNTT_dsub_64ns_64ns_64_5_full_dsp_0_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files fiFFNTT_dsub_64ns_64ns_64_5_full_dsp_0_ip.xci]
generate_target {synthesis simulation} [get_files fiFFNTT_dsub_64ns_64ns_64_5_full_dsp_0_ip.xci]
