...
localparam
    ...
    ADDR_MODE_DATA_0    = 6'h1c,
    ADDR_MODE_CTRL      = 6'h20,
    ADDR_INVERSE_DATA_0 = 6'h24,
    ADDR_INVERSE_CTRL   = 6'h28,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INVERSE_DATA_0: begin
                    rdata <= int_inverse[0:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_INVERSE_DATA_0)
            int_inverse[0:0] <= (WDATA[31:0] & wmask) | (int_inverse[0:0] & ~wmask);
    end
end
