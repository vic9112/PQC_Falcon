...
architecture behav of fiFFNTT_in_copy_1 is 
...
attribute shreg_extract : string;
    ...
    signal in_buf1_addr_reg_189 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state8_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state9_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln27_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_buf1_addr_reg_189_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal sext_ln32_fu_120_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_70 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln27_fu_145_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln32_fu_164_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln32_2_fu_110_p4 : STD_LOGIC_VECTOR (60 downto 0);
    signal trunc_ln32_fu_161_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln27_fu_139_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_fu_70 <= add_ln27_fu_145_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                in_buf1_addr_reg_189_pp0_iter1_reg <= in_buf1_addr_reg_189;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln27_fu_139_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                in_buf1_addr_reg_189 <= zext_ln27_fu_151_p1(10 - 1 downto 0);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, ap_enable_reg_pp0_iter1, icmp_ln27_fu_139_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln27_fu_139_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln27_fu_139_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
    ...
    add_ln27_fu_145_p2 <= std_logic_vector(unsigned(i_fu_70) + unsigned(ap_const_lv11_1));
    ...
    ap_condition_pp0_exit_iter0_state8_assign_proc : process(icmp_ln27_fu_139_p2)
    begin
        if ((icmp_ln27_fu_139_p2 = ap_const_lv1_1)) then 
    ...
    icmp_ln27_fu_139_p2 <= "1" when (i_fu_70 = ap_const_lv11_400) else "0";
    in_buf1_address0 <= in_buf1_addr_reg_189_pp0_iter1_reg;

    in_buf1_ce0_assign_proc : process(mode_read_read_fu_87_p2, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (mode_read_read_fu_87_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (mode_read_read_fu_87_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
            in_buf1_ce0 <= ap_const_logic_1;
        else 
            in_buf1_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    in_buf1_d0_assign_proc : process(ap_block_pp0_stage0, mode_read_read_fu_87_p2, gmem0_addr_read_reg_194, ap_enable_reg_pp0_iter2, zext_ln32_fu_164_p1)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then
            if ((mode_read_read_fu_87_p2 = ap_const_lv1_1)) then 
                in_buf1_d0 <= gmem0_addr_read_reg_194;
            elsif ((mode_read_read_fu_87_p2 = ap_const_lv1_0)) then 
                in_buf1_d0 <= zext_ln32_fu_164_p1;
            else 
                in_buf1_d0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            in_buf1_d0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    in_buf1_we0_assign_proc : process(mode_read_read_fu_87_p2, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
            if ((mode_read_read_fu_87_p2 = ap_const_lv1_1)) then 
                in_buf1_we0 <= ap_const_lv8_FF;
            elsif ((mode_read_read_fu_87_p2 = ap_const_lv1_0)) then 
                in_buf1_we0 <= ap_const_lv8_3;
            else 
                in_buf1_we0 <= ap_const_lv8_0;
            end if;
        else 
            in_buf1_we0 <= ap_const_lv8_0;
        end if; 
    ...
    m_axi_gmem0_ARADDR <= sext_ln32_fu_120_p1;
    ...
    mode_read_read_fu_87_p2 <= mode;
        sext_ln32_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln32_2_fu_110_p4),64));

    trunc_ln32_2_fu_110_p4 <= in_buf(63 downto 3);
    trunc_ln32_fu_161_p1 <= gmem0_addr_read_reg_194(16 - 1 downto 0);
    zext_ln27_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_70),64));
    zext_ln32_fu_164_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln32_fu_161_p1),64));
end behav;
