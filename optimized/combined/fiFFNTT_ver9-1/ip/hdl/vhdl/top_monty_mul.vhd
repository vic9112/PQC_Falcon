...
attribute shreg_extract : string;
    ...
    signal zext_ln238_fu_50_p0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln236_2_fu_71_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp2_1_fu_75_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_15_fu_87_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln236_fu_95_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_ln236_fu_81_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    add_ln236_fu_81_p2 <= std_logic_vector(unsigned(trunc_ln5_fu_61_p4) + unsigned(ap_const_lv16_CFFF));
    ...
    grp_fu_116_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln238_fu_50_p0),30));
    grp_fu_116_p1 <= ap_const_lv30_3001(14 - 1 downto 0);
    select_ln236_fu_95_p3 <= 
        ap_const_lv16_3001 when (tmp_15_fu_87_p3(0) = '1') else 
        ap_const_lv16_0;
    tmp2_1_fu_75_p2 <= std_logic_vector(unsigned(zext_ln236_2_fu_71_p1) + unsigned(ap_const_lv17_1CFFF));
    tmp2_2_fu_103_p2 <= std_logic_vector(unsigned(select_ln236_fu_95_p3) + unsigned(add_ln236_fu_81_p2));
    ...
    zext_ln236_2_fu_71_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln5_fu_61_p4),17));
    zext_ln238_fu_50_p0 <= grp_fu_109_p2;
end behav;
