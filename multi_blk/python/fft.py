...
def fft(f):
    ...
    n = len(f)
# ====================================================================== #
#   For comparing the IP and function, we should comment the following
# ====================================================================== #
#    if (n == 1024):
#        global n_1024 
#        n_1024 += 1
...
#        print("not logn")
    ...
    if (n == 1024):
        ...
        for i in range(n):
            tmp[i] = inBufferFFT[i]
        f_fft = get_fft512(tmp)

# ====================================================================== #
#   For testing the IP under falcon.py, above comment must be canceled
# ====================================================================== #
    elif (n > 2):
        f0, f1 = split(f)
        f0_fft = fft(f0)
