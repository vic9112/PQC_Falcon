...
entity iFFT_Block_entry18_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of iFFT_Block_entry18_proc is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln1460_fu_48_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal n_fu_52_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal hn_fu_58_p4 : STD_LOGIC_VECTOR (62 downto 0);
    signal zext_ln1463_fu_68_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (logn_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_0_preg(31 downto 0) <= zext_ln1460_fu_48_p1(31 downto 0);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                ap_return_2_preg(49) <= '0';
                ap_return_2_preg(50) <= '0';
                ap_return_2_preg(51) <= '0';
                ap_return_2_preg(52) <= '0';
                ap_return_2_preg(53) <= '0';
                ap_return_2_preg(54) <= '0';
                ap_return_2_preg(55) <= '0';
                ap_return_2_preg(56) <= '0';
                ap_return_2_preg(57) <= '0';
                ap_return_2_preg(58) <= '0';
                ap_return_2_preg(59) <= '0';
                ap_return_2_preg(60) <= '0';
                ap_return_2_preg(61) <= '0';
                ap_return_2_preg(62) <= '0';
            else
                if ((not(((ap_start = ap_const_logic_0) or (logn_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_2_preg(62 downto 0) <= zext_ln1463_fu_68_p1(62 downto 0);
                end if; 
            end if;
        end if;
    end process;

    ap_return_0_preg(63 downto 32) <= "00000000000000000000000000000000";
    ap_return_2_preg(63) <= '0';
    ...
    ap_return_0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, logn_c_full_n, zext_ln1460_fu_48_p1, ap_return_0_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (logn_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= zext_ln1460_fu_48_p1;
        else 
    ...
    ap_return_2_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, logn_c_full_n, zext_ln1463_fu_68_p1, ap_return_2_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (logn_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_2 <= zext_ln1463_fu_68_p1;
        else 
    ...
    n_fu_52_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv64_1),to_integer(unsigned('0' & zext_ln1460_fu_48_p1(31-1 downto 0)))));
    zext_ln1460_fu_48_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(logn),64));
    zext_ln1463_fu_68_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(hn_fu_58_p4),64));
end behav;
