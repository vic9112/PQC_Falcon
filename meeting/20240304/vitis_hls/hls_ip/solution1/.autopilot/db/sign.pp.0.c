...
# 2 "<built-in>" 2
# 1 "../FalconHLS/code_hls/sign.c" 2
# 32 "../FalconHLS/code_hls/sign.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "../FalconHLS/code_hls/sign.c" 2
# 52 "../FalconHLS/code_hls/sign.c"
unsigned ffLDL_treesize(unsigned logn)
{
# 63 "../FalconHLS/code_hls/sign.c"
 return (logn + 1) << logn;
}
...
# 332 "../FalconHLS/code_hls/sign.c"
 ...
 VITIS_LOOP_345_1: for(int i = 0; i<n_it; ++i)
 {
...
# 871 "../FalconHLS/code_hls/sign.c"
 ...
 VITIS_LOOP_877_1: for(int i = 0; i<n_it; ++i){
...
void ffLDL_binary_normalize_it(fpr *tree, unsigned orig_logn, unsigned logn)
{
 ...
 VITIS_LOOP_1010_1: for(int i = 0; i < n_it; ++i){
...
void smallints_to_fpr(fpr *r, const int8_t *t, unsigned logn)
{
 ...
 n = ((size_t)1 << (logn));
 VITIS_LOOP_1063_1: for (u = 0; u < n; u ++) {
  r[u] = fpr_of(t[u]);
 }
}
...
# 1113 "../FalconHLS/code_hls/sign.c"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 poly_neg(rf, logn);
 poly_neg(rF, logn);
# 1175 "../FalconHLS/code_hls/sign.c"
 g00 = (fpr *)tmp;
 g01 = g00 + n;
 g11 = g01 + n;
 gxx = g11 + n;
...
# 1229 "../FalconHLS/code_hls/sign.c"
 ...
 unsigned logn)
{
 ...
 VITIS_LOOP_1255_1: for (u = 0; u < n; u ++) {
  t0[u] = fpr_of(hm[u]);
 ...
 sqn = 0;
 ng = 0;
 VITIS_LOOP_1308_2: for (u = 0; u < n; u ++) {
  int32_t z;
 ...
 sqn |= -(ng >> 31);
# 1326 "../FalconHLS/code_hls/sign.c"
 int16_t s2tmp[1024];
 VITIS_LOOP_1327_3: for (u = 0; u < n; u ++) {
...
int64_t gaussian0_sampler(prng *p)
{
 ...
 z = 0;
 VITIS_LOOP_1387_1: for (u = 0; u < (sizeof dist) / sizeof(dist[0]); u += 3) {
...
# 1428 "../FalconHLS/code_hls/sign.c"
 sw = (uint32_t)s;
 sw ^= (sw ^ 63) & -((63 - sw) >> 31);
 s = (int)sw;
# 1443 "../FalconHLS/code_hls/sign.c"
...
# 1472 "../FalconHLS/code_hls/sign.c"
int64_t sampler(void *ctx, fpr mu, fpr isigma)
{
 sampler_context *spc;
 int64_t s;
 ...
 VITIS_LOOP_1503_1: for (;;) {
#pragma HLS LOOP_TRIPCOUNT max=1
 int64_t z0, z, b;
  fpr x;
# 1519 "../FalconHLS/code_hls/sign.c"
  z0 = gaussian0_sampler(&spc->p);
  b = (int64_t)prng_get_u8(&spc->p) & 1;
  z = b + ((b << 1) - 1) * z0;
  z_fp = fpr_of(z);
# 1548 "../FalconHLS/code_hls/sign.c"
...
# 1571 "../FalconHLS/code_hls/sign.c"
void bug(double *in, double *out, double *out2, int32_t *out_int){
...
#pragma HLS array_partition variable=rng type=complete
 ...
 VITIS_LOOP_1626_1: for (;;) {
# 1637 "../FalconHLS/code_hls/sign.c"
  sampler_context spc;
...
# 1670 "../FalconHLS/code_hls/sign.c"
 ...
 const uint16_t *hm, unsigned logn, fpr *tmp)
{
 ...
 poly_neg(b01, logn);
 poly_neg(b11, logn);
# 1717 "../FalconHLS/code_hls/sign.c"
 t0 = b11 + n;
 t1 = t0 + n;
 ...
 t0 = b01 + n;
 t1 = t0 + n;
# 1757 "../FalconHLS/code_hls/sign.c"
 VITIS_LOOP_1757_1: for (u = 0; u < n; u ++) {
  t0[u] = fpr_of(hm[u]);
...
# 1802 "../FalconHLS/code_hls/sign.c"
 b00 = tmp;
 b01 = b00 + n;
 b10 = b01 + n;
 b11 = b10 + n;
 ...
 sqn = 0;
 ng = 0;
 VITIS_LOOP_1842_2: for (u = 0; u < n; u ++) {
  int32_t z;
 ...
 sqn |= -(ng >> 31);
# 1861 "../FalconHLS/code_hls/sign.c"
 s2tmp = (int16_t *)tmp;
 VITIS_LOOP_1862_3: for (u = 0; u < n; u ++) {
  s2tmp[u] = (int16_t)-fpr_rint(t1[u]);
 }
 if (is_short_half(sqn, s2tmp, logn)) {
  memcpy(s2, s2tmp, n * sizeof *s2);
...
# 1889 "../FalconHLS/code_hls/sign.c"
void sign_tree(int16_t sig[1024], fpr expanded_key[15360], uint16_t hm[1024], uint8_t msg[50], uint8_t seed[48])
{
...
#pragma HLS array_partition variable=rng type=complete
 ...
 i_shake256_flip(&rng);
  ...
  VITIS_LOOP_1918_1: for(;;){
#pragma HLS LOOP_TRIPCOUNT max=1
# 1930 "../FalconHLS/code_hls/sign.c"
 sampler_context spc;
 ...
 const uint16_t *hm, unsigned logn, uint8_t *tmp2)
{
 ...
 logn = 10;
 ftmp = (fpr *)tmp;
  VITIS_LOOP_1962_1: for(;;){
# 1973 "../FalconHLS/code_hls/sign.c"
  sampler_context spc;
