...
# 2 "<built-in>" 2
# 1 "../FalconHLS/code_hls/common.c" 2
# 32 "../FalconHLS/code_hls/common.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "../FalconHLS/code_hls/common.c" 2
...
{
# 50 "../FalconHLS/code_hls/common.c"
 size_t n;
...
{
# 103 "../FalconHLS/code_hls/common.c"
...
# 159 "../FalconHLS/code_hls/common.c"
 VITIS_LOOP_159_2: for (p = 1; p <= over; p <<= 1) {
  unsigned v;
# 175 "../FalconHLS/code_hls/common.c"
  v = 0;
