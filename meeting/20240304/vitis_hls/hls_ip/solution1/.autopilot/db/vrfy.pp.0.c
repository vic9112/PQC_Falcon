...
# 2 "<built-in>" 2
# 1 "../FalconHLS/code_hls/vrfy.c" 2
# 32 "../FalconHLS/code_hls/vrfy.c"
...
1, 0, 0, 1, 0, 0, 4, 3, 2, 1, 0, 0, 1, 0, 0, 2, 1, 0, 0, 1, 0, 0, 3, 2, 1, 0, 0, 1, 0, 0,
2, 1, 0, 0, 1, 0, 0};
# 33 "../FalconHLS/code_hls/vrfy.c" 2
# 57 "../FalconHLS/code_hls/vrfy.c"
...
mq_NTT(uint16_t *a, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 t = n;
 VITIS_LOOP_511_1: for (m = 1; m < n; m <<= 1) {
  size_t ht, i, j1;

  ht = t >> 1;
  VITIS_LOOP_515_2: for (i = 0, j1 = 0; i < m; i ++, j1 += t) {
   size_t j, j2;
   uint32_t s;

   s = GMb[m + i];
   j2 = j1 + ht;
   VITIS_LOOP_521_3: for (j = j1; j < j2; j ++) {
    uint32_t u, v;
...
mq_iNTT(uint16_t *a, unsigned logn)
{
 ...
 t = 1;
 m = n;
 VITIS_LOOP_547_1: while (m > 1) {
  size_t hm, dt, i, j1;

  hm = m >> 1;
  dt = t << 1;
  VITIS_LOOP_552_2: for (i = 0, j1 = 0; i < hm; i ++, j1 += dt) {
   size_t j, j2;
   uint32_t s;

   j2 = j1 + t;
   s = iGMb[hm + i];
   VITIS_LOOP_558_3: for (j = j1; j < j2; j ++) {
    uint32_t u, v, w;
...
# 582 "../FalconHLS/code_hls/vrfy.c"
 ni = 4091;
 VITIS_LOOP_583_4: for (m = n; m > 1; m >>= 1) {
  ni = mq_rshift1(ni);
 }
 VITIS_LOOP_586_5: for (m = 0; m < n; m ++) {
...
mq_poly_tomonty(uint16_t *f, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_600_1: for (u = 0; u < n; u ++) {
...
mq_poly_montymul_ntt(uint16_t *f, const uint16_t *g, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_615_1: for (u = 0; u < n; u ++) {
...
mq_poly_sub(uint16_t *f, const uint16_t *g, unsigned logn)
{
 ...
 n = (size_t)1 << logn;
 VITIS_LOOP_629_1: for (u = 0; u < n; u ++) {
 ...
 const uint16_t *h, unsigned logn, uint8_t *tmp)
{
 ...
 VITIS_LOOP_780_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 VITIS_LOOP_799_2: for (u = 0; u < n; u ++) {
  int32_t w;
 ...
 unsigned logn, uint8_t *tmp)
{
 ...
 t1 = (uint16_t *)tmp;
 t2 = t1 + n;
 VITIS_LOOP_852_1: for (u = 0; u < n; u ++) {
 ...
 VITIS_LOOP_860_2: for (u = 0; u < n; u ++) {
  t2[u] = (uint16_t)mq_conv_small(f[u]);
 }
 mq_NTT(t2, logn);
 VITIS_LOOP_864_3: for (u = 0; u < n; u ++) {
  if (t2[u] == 0) {
   return 0;
  }
 ...
 mq_iNTT(t1, logn);
 VITIS_LOOP_871_4: for (u = 0; u < n; u ++) {
  uint32_t w;
  int32_t gi;
 ...
 const int16_t *s2, unsigned logn, uint8_t *tmp)
{
 ...
 n = (size_t)1 << logn;
 tt = (uint16_t *)tmp;
 VITIS_LOOP_897_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 mq_NTT(tt, logn);
 r = 0;
 VITIS_LOOP_906_2: for (u = 0; u < n; u ++) {
  r |= (uint32_t)(tt[u] - 1);
 }
 return (int)(1u - (r >> 31));
}
 ...
 unsigned logn, uint8_t *tmp)
{
 ...
 tt = (uint16_t *)tmp;
 VITIS_LOOP_929_1: for (u = 0; u < n; u ++) {
  uint32_t w;
...
# 949 "../FalconHLS/code_hls/vrfy.c"
 mq_NTT(tt, logn);
 mq_NTT(h, logn);
 r = 0;
 VITIS_LOOP_952_2: for (u = 0; u < n; u ++) {
  r |= (uint32_t)(tt[u] - 1);
  h[u] = (uint16_t)mq_div_12289(h[u], tt[u]);
 }
 mq_iNTT(h, logn);
...
count_nttzero(const int16_t *sig, unsigned logn, uint8_t *tmp)
{
 ...
 n = (size_t)1 << logn;
 s2 = (uint16_t *)tmp;
 VITIS_LOOP_978_1: for (u = 0; u < n; u ++) {
  uint32_t w;
 ...
 mq_NTT(s2, logn);
 r = 0;
 VITIS_LOOP_987_2: for (u = 0; u < n; u ++) {
  uint32_t w;
