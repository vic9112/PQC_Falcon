set moduleName poly_small_mkgauss
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {poly_small_mkgauss}
...
set C_modelArgList {
	...
	{ f int 8 regular {array 1024 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "f", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ f_address0 sc_out sc_lv 10 signal 26 } 
	{ f_ce0 sc_out sc_logic 1 signal 26 } 
	{ f_we0 sc_out sc_logic 1 signal 26 } 
	{ f_d0 sc_out sc_lv 8 signal 26 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "f_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "f", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "RC", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_get_rng_u64_82_101_fu_718", "Port" : "RC", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gauss_1024_12289_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_get_rng_u64_82_101_fu_718", "Parent" : "0", "Child" : ["3", "4", "6"],
		...
		"Port" : [
			...
			{"Name" : "RC", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_process_block_111_112_fu_512", "Port" : "RC", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_get_rng_u64_82_101_fu_718.tmp_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_get_rng_u64_82_101_fu_718.grp_process_block_111_112_fu_512", "Parent" : "2", "Child" : ["5"],
	...
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_get_rng_u64_82_101_fu_718.grp_process_block_111_112_fu_512.RC_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_get_rng_u64_82_101_fu_718.mux_2561_64_1_1_U27", "Parent" : "2"}]}
...
set Spec2ImplPortList { 
	...
	f { ap_memory {  { f_address0 mem_address 1 10 }  { f_ce0 mem_ce 1 1 }  { f_we0 mem_we 1 1 }  { f_d0 mem_din 1 8 } } }
}
