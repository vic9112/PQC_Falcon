set moduleName get_rng_u64_82_101
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {get_rng_u64.82.101}
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rng_dptr_read", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rng_dptr_read sc_in sc_lv 64 signal 25 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rng_dptr_read", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "rng_dptr_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4"],
		...
		"Port" : [
			...
			{"Name" : "RC", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_process_block_111_112_fu_512", "Port" : "RC", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_process_block_111_112_fu_512", "Parent" : "0", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_process_block_111_112_fu_512.RC_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2561_64_1_1_U27", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10", "Max" : "195"}
	, {"Name" : "Interval", "Min" : "10", "Max" : "195"}
]}
...
set Spec2ImplPortList { 
	...
	rng_dptr_read { ap_none {  { rng_dptr_read in_data 0 64 } } }
}
